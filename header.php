	...
	<header class="site-header">
		<div class="row">
			<div class="columns medium-8 medium-centered">
				<a class="site-title" href="<?php echo esc_url( home_url( '/' ) ); ?>">Daniel Bachhuber</a> <span class="social"><a href="https://tinyletter.com/danielbachhuber"><i class="fa fa-twitter"></i></a> <a href="https://github.com/danielbachhuber"><i class="fa fa-github"></i></a></span>
