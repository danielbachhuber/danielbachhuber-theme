...
class Assets extends Controller {
	...
	public function action_admin_enqueue_scripts() {
		...
		wp_enqueue_style( 'db-admin', get_template_directory_uri() . '/assets/css/admin.css?r=' . (int) $time );
		// $time = filemtime( get_template_directory() . '/assets/js/admin.js' );
		// wp_enqueue_script( 'db-admin', get_stylesheet_directory_uri() . '/assets/js/admin.js?r=' . (int) $time, array( 'jquery' ) );
	...
	public function action_wp_enqueue_scripts() {
		...
		wp_enqueue_style( 'db', get_template_directory_uri() . '/assets/css/style.css?r=' . (int) $time, array( 'google-fonts' ) );
	}
